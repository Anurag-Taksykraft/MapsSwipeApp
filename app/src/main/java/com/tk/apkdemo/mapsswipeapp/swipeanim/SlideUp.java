package com.tk.apkdemo.mapsswipeapp.swipeanim;
...
import static com.tk.apkdemo.mapsswipeapp.swipeanim.SlideUp.State.HIDDEN;
import static com.tk.apkdemo.mapsswipeapp.swipeanim.SlideUp.State.SHOWED;
            ...
            case BOTTOM:
                if (immediately) {
                    if (mBuilder.mSliderView.getHeight() > 0) {
                        ...
                        mAnimationProcessor.setValuesAndStart(mBuilder.mSliderView.getTranslationY(), mBuilder.mSliderView.getHeight()-60);
                    } else {
                        mBuilder.mStartState = HIDDEN;
                    }
                } else {
