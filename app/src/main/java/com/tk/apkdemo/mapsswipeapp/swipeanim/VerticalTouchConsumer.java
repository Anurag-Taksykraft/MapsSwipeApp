        ...
        switch (event.getActionMasked()){
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (scrollableAreaConsumed && mGoingDown){
                    mAnimationProcessor.setValuesAndStart(slideAnimationFrom, (mBuilder.mSliderView.getHeight() - 60));
                } else {
                    mAnimationProcessor.setValuesAndStart(slideAnimationFrom, mBuilder.mSliderView.getHeight()/4);
                }
                mCanSlide = true;
                mGoingUp = false;
                mGoingDown = false;
